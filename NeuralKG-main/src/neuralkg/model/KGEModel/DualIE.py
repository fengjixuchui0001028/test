...
class DualE(Model):
    ...
    def init_weights(self):
        ...
        r, i, j, k, r_1, i_1, j_1, k_1 = torch.from_numpy(r), torch.from_numpy(i), torch.from_numpy(
            j), torch.from_numpy(k), \
                                         torch.from_numpy(r_1), torch.from_numpy(i_1), torch.from_numpy(
            j_1), torch.from_numpy(k_1)
        ...
        s, x, y, z, s_1, x_1, y_1, z_1 = torch.from_numpy(s), torch.from_numpy(x), torch.from_numpy(
            y), torch.from_numpy(z), \
                                         torch.from_numpy(s_1), torch.from_numpy(x_1), torch.from_numpy(
            y_1), torch.from_numpy(z_1)
